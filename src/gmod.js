 ...
 * https://github.com/midday/gmodjs
...
Tmod.prototype = {
    ...
    getConfig: function () {
        ...
        var targetVersion = json.dependencies.gmodjs.replace(/^~/, '');
        ...
        try {
            ...
            if (semver.lt(version, targetVersion)) {
                this.log('[red]You must upgrade to the latest version of gmodjs![/red]\n');
        ...
        // 更新模板项目的依赖版本信息
        json.dependencies.gmodjs = version;
